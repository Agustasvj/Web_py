<div style="font-family:Arial, sans-serif; color:#e5e7eb;">
  ...
  <p style="font-size:12px; color:#9ca3af; margin:0;">Powered by</p>

  <h1 style="font-size:48px; margin:6px 0 12px 0; color:#3b82f6;">SIERRA. VJ</h1>

  <hr style="border:none; height:1px; background:#374151; margin:10px 0 18px 0;" />
  ...
  <p style="margin:18px 0 6px 0; font-size:16px;">Happy holidays 🎉 — ¡Felices fiestas!</p>
